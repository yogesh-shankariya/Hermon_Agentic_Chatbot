...
For user-facing business KPI wording, match the dashboard definitions from `docs/dashboard_metrics_reference.md`. This section wins over raw appointment row-count examples below.
